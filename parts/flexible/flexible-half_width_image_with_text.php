        ...
        <div class="grid-x section-row <?php echo $image_position ? 'section-row__reverce' : '' ?>">
            <div class="cell large-6">
                <div class="section-image <?php echo $section_bottom_image ? 'with-bottom-image' : ''; ?>">
                    <?php echo wp_get_attachment_image( $section_image['id'], 'full_hd', false, ['class' => 'main-image ease-btm', 'loading' => 'eager', 'data-scroll' => ''] ); ?>
                    <?php if ( $section_bottom_image == true ) :
                        echo wp_get_attachment_image( $bottom_image['id'], 'full_hd', false, ['class' => 'bottom-image ease-btm', 'loading' => 'eager', 'data-scroll' => ''] );
                    endif; ?>

                    <?php if ( $section_top_image == true ) :
                        echo wp_get_attachment_image( $top_image['id'], 'full_hd', false, ['class' => 'top-image ease-btm', 'loading' => 'eager', 'data-scroll' => ''] );
                    endif; ?>
                </div>
            </div>
            <div class="cell large-6">
